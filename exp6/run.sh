echo "ubuntu(24.04, reference)"
apt update
apt install build-essential git m4 scons zlib1g zlib1g-dev \
	libprotobuf-dev protobuf-compiler libprotoc-dev libgoogle-perftools-dev \
	python3-dev python-is-python3 libboost-all-dev pkg-config
apt install llvm clang llvm-dev llvm-runtime lldb lld
apt install gcc-multilib gcc-arm-none-eabi
apt install vim
...
cd $M5_PATH/benchmarks/sys_validation/gemm
cd sw
