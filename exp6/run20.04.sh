...
apt install build-essential \
	cmake git m4 scons zlib1g zlib1g-dev \
	...
	llvm-12 llvm-12-tools clang-12
...
apt install vim
python3 -m venv --system-site-package ~/python_venv
source ~/python_venv/bin/activate
pip install -r requirements.txt

# modify docs/update-alternatives.sh
cd ..
bash gem5-salam/docs/update-alternatives.sh
